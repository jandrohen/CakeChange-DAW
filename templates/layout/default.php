...
<head>
    ...
    <?= $this->Html->css(['rendr-90GxdymbsohR-PsSMAgf-_TfzdHSFebyJIsjDuEh390.css']) ?>
    <?= $this->Html->script(['main.min.js', 'changeAssets-c2c0f5d139b6d23e9754.js', '11391265293.js']) ?>
    ...
    <link rel="icon" type="image/png" href="<?= $this->Url->build('/') ?>img/favicon-48x48.png" />
    <link rel="apple-touch-icon" href="<?= $this->Url->build('/') ?>img/favicon-57x57.png" />
    <link rel="apple-touch-icon" sizes="72x72" href="<?= $this->Url->build('/') ?>img/favicon-72x72.png" />
    <link rel="apple-touch-icon" sizes="114x114" href="<?= $this->Url->build('/') ?>public/img/favicon-114x114.png" />
...
<body>
    ...
    <div class="page-wrap">
        ...
        <footer>
            <div data-scroll-identifier="page_footer" class="footer js-track-scroll" data-view="components/footer" style="height: 1px;">
